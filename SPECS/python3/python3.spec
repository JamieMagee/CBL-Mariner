...
%{_libdir}/python%{majmin}/site-packages/easy_install.py
...
%exclude %{_libdir}/python%{majmin}/test
%exclude %{_libdir}/python%{majmin}/lib-dynload/_ctypes_test.*.so
%exclude %{_libdir}/python%{majmin}/xml
%exclude %{_libdir}/python%{majmin}/lib-dynload/pyexpat*.so
%exclude %{_libdir}/python%{majmin}/curses
%exclude %{_libdir}/python%{majmin}/lib-dynload/_curses*.so
%exclude %{_libdir}/python%{majmin}/distutils/command/wininst-*.exe

%files xml
%{_libdir}/python%{majmin}/xml/*
%{_libdir}/python%{majmin}/lib-dynload/pyexpat*.so
...
%{_libdir}/python%{majmin}/site-packages/setuptools-%{version}.dist-info/*
%{_bindir}/easy_install-%{majmin}
